...
public class AnimalsEndActivity extends BaseActivity {

	/**
	 * This class displays the video at the end of the category Animals
	 */
	private static final String TAG = "AnimalsEndActivity";
	...
	public void onCreate(Bundle icicle) {
		...
		if (cc.contains("fr")) {
			myApp.playMusicVideo("level1_fr.ogg");
		} else {
			myApp.playMusicVideo("level1_en.ogg");
		}
		setContentView(R.layout.activity_end);
		mVideoView = (VideoView) findViewById(R.id.surface_view);
		mVideoView.setVideoURI(Uri.parse("android.resource://"
				+ getPackageName() + "/" + R.raw.level1));
	...
	private void startCategoryActivity() {
		...
		intent.setClass(AnimalsEndActivity.this, CategoryScreenActivity.class);
		startActivity(intent);
		finish();
	}
