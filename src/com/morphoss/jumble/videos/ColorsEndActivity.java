...
public class ColorsEndActivity extends BaseActivity {

	/**
	 * This class displays the video at the end of the category Colors
	 */
	private static final String TAG = "ColorsEndActivity";
	...
	public void onCreate(Bundle icicle) {
		...
		if (cc.contains("fr")) {
			myApp.playMusicVideo("level5_fr.ogg");
		} else {
			myApp.playMusicVideo("level5_en.ogg");
		}
		setContentView(R.layout.activity_end);
		mVideoView = (VideoView) findViewById(R.id.surface_view);
		mVideoView.setVideoURI(Uri.parse("android.resource://"
				+ getPackageName() + "/" + R.raw.level5));
	...
	private void startCategoryActivity() {
		...
		intent.setClass(ColorsEndActivity.this, CategoryScreenActivity.class);
		startActivity(intent);
		finish();
	}
