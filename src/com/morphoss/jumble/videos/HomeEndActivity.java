...
public class HomeEndActivity extends BaseActivity {

	/**
	 * This class displays the video at the end of the category Home
	 */
	private static final String TAG = "HomeEndActivity";
	...
	public void onCreate(Bundle icicle) {
		...
		if (cc.contains("fr")) {
			myApp.playMusicVideo("level3_fr.ogg");
		} else {
			myApp.playMusicVideo("level3_en.ogg");
		}
		setContentView(R.layout.activity_end);
		mVideoView = (VideoView) findViewById(R.id.surface_view);
		mVideoView.setVideoURI(Uri.parse("android.resource://"
				+ getPackageName() + "/" + R.raw.level3));
	...
	private void startCategoryActivity() {
		...
		intent.setClass(HomeEndActivity.this, CategoryScreenActivity.class);
		startActivity(intent);
		finish();
	}
