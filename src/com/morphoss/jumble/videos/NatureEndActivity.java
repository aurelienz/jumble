...
public class NatureEndActivity extends BaseActivity {

	/**
	 * This class displays the video at the end of the category Nature
	 */
	private static final String TAG = "NatureEndActivity";
	...
	public void onCreate(Bundle icicle) {
		...
		if (cc.contains("fr")) {
			myApp.playMusicVideo("level4_fr.ogg");
		} else {
			myApp.playMusicVideo("level4_en.ogg");
		}
		setContentView(R.layout.activity_end);
		mVideoView = (VideoView) findViewById(R.id.surface_view);
		mVideoView.setVideoURI(Uri.parse("android.resource://"
				+ getPackageName() + "/" + R.raw.level4));
	...
	private void startCategoryActivity() {
		...
		intent.setClass(NatureEndActivity.this, CategoryScreenActivity.class);
		startActivity(intent);
		finish();
	}
